...
const WebApp = ({ title, text, imageSrc, href }) => {
  ...
  const handleResize = () => {
    var ratio = 0.6485;
    var widthCard = window.innerWidth > 550 ? 500 : window.innerWidth * 0.9;
    setHeightCard(ratio * widthCard);
  };
  return (
    <a href={href} target="blank" className="work-page-web-app">
      <div className="work-page-web-app-image" style={{ height: heightCard }}>
